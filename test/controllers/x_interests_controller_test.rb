...
class XInterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create x_interest" do
    assert_difference("XInterest.count") do
      post x_interests_url, params: { x_interest: { query: @x_interest.query, type: @x_interest.type, user_id: @x_interest.user_id } }
    end
  ...
  test "should update x_interest" do
    patch x_interest_url(@x_interest), params: { x_interest: { query: @x_interest.query, type: @x_interest.type, user_id: @x_interest.user_id } }
